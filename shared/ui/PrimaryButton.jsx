...
export function PrimaryButton({ title, variant = 'filled', loading, disabled, textStyle, style, ...rest }) {
    const isDisabled = disabled || loading;
    return (<Pressable accessibilityRole="button" disabled={isDisabled} style={({ pressed }) => [
            styles.base,
      ...
      {loading ? (<ActivityIndicator color={variant === 'filled' ? Colors.white : Colors.primary}/>) : (<Text style={[
                styles.label,
