...
export function LocationCard({ pickup, drop, distanceKm, fare, customerName, onCall, }) {
    return (<View style={styles.card}>
      ...
      <View style={styles.metaRow}>
        ...
        <View style={styles.customerWrap}>
          ...
          {onCall ? (<Pressable onPress={onCall} hitSlop={8} style={styles.callBtn}>
...
const styles = StyleSheet.create({
    ...
    dotPickup: {
        ...
        height: 10,
        borderRadius: 5,
        backgroundColor: Colors.mapPickupAccent,
    },
    dotDrop: {
        width: 10,
        height: 10,
        borderRadius: 5,
        backgroundColor: Colors.mapDropAccent,
    },
    dotted: {
        borderLeftWidth: 2,
        borderColor: Colors.border,
